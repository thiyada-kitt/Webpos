...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>EATZABB </b>- POS</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li><a href="createorder2.php"><i class="fa fa-first-order2"></i> <span>Create order</span></a></li>
          <li><a href="orderlist2.php"><i class="fa fa-list-ul2"></i> <span>Order list</span></a></li>
