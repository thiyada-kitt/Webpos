      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li><a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li> -->
         ...
         <li><a href="category.php"><i class="fa fa-list-alt"></i> <span>Category</span></a></li>
          ...
          <li><a href="addproduct.php"><i class="fa fa-product-hunt"></i> <span>Add Menu</span></a></li>
          
           <li><a href="productlist.php"><i class="fa fa-th-list"></i> <span>Menu list</span></a></li>
